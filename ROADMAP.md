...
- integrated selftest latest run summary is {"ok": true, "passed": 300, "failed": 0, "total": 300}.
...
- coverage now also includes Stage 2G-D package-manager strategy classification and dependency planning contract checks, and Stage 2G-D forward-fix regression checks for host_profile distro_like resolution, rpm-ostree non-host-package claims, and manual-review next-step aggregation.
