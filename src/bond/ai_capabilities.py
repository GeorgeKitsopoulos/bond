...
_REGISTRY_ENTRIES: tuple[Capability, ...] = (
    ...
    _cap(
        ...
        rootless=True,
        interactive=True,
        notes="Planned voice input/output surface. Not implemented in the current phase.",
    ),
    _cap(
        name="desktop_applet",
        capability_class=CLASS_HANDOFF,
        ...
        interactive=True,
        needs_gui_session=True,
        notes="Planned Cinnamon/tray applet surface. Not implemented in the current phase.",
    ),
    _cap(
        name="web_search",
        capability_class=CLASS_INSPECTOR,
        ...
        rootless=True,
        needs_network=True,
        notes="Planned web/search capability. Not currently wired and must not be described as available.",
    ),
    _cap(
        ...
        read_only=True,
        rootless=True,
        notes="Partial local memory/logging/project-state support exists, but it is bounded and not a complete long-term personal memory system.",
    ),
    _cap(
        ...
        read_only=True,
        rootless=True,
        notes="Planned bounded local file reading. Arbitrary local file reading is not currently available.",
    ),
    _cap(
    ...
    _cap(
        ...
        needs_network=False,
        needs_elevated_lane=False,
        result_schema="context_capability_answer",
        error_schema="standard_error",
        audit_tag="describe_context_capabilities",
        required_tools=("host_baseline", "session_baseline", "tool_inventory", "model_truth"),
        notes="Bounded explicit context-capability answer using existing read-only probes only; does not authorize execution and does not make normal assistant answers broadly probe-backed.",
    ),
    _cap(
        ...
        needs_network=False,
        needs_elevated_lane=False,
        result_schema="maintenance_readiness_report",
        error_schema="standard_error",
        audit_tag="describe_maintenance_readiness",
        required_tools=("host_baseline", "session_baseline", "tool_inventory", "model_truth"),
        notes="Bounded read-only maintenance/readiness report using existing read-only probes only; does not inspect real package freshness, logs, or storage usage and does not fix, install, delete, update, restart, or authorize execution.",
    ),
    _cap(
        name="preview_action",
        capability_class=CLASS_INSPECTOR,
