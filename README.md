...
- The current validated baseline is Stage 2G-F-E user-space install execution-gate/readiness decision.
...
- Current documented validation baseline: compile passes and integrated selftest currently reports {"ok": true, "passed": 351, "failed": 0, "total": 351} (see docs/TESTING.md for exact summary).
