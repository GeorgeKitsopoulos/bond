...
- Current documented validation baseline: compile passes and integrated selftest currently reports {"ok": true, "passed": 302, "failed": 0, "total": 302} (see docs/TESTING.md for exact summary).
