...
Current integrated selftest summary from latest run is {"ok": true, "passed": 268, "failed": 0, "total": 268}. Coverage includes Stage 2E parser-contract/action-preflight checks,
